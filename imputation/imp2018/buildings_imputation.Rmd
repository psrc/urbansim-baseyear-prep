...
save.as.csv <- TRUE
out.file.name <- "imputed_buildings_20200707.csv"
...
2. Set as missing values of:
    ...
    * non_residential_sqft in records in non-residential and mix-use buildings (excluding group quarters and governmental buildings) with zero non_residential_sqft (`r sum(is.na(bld$non_residential_sqft))`)
