...
* parcels_prelim.csv or parcels.csv if newer (combined 4-counties parcels with info about census blocks)
* one of:
...
```{r, echo=TRUE}
bld.file.name <- "buildings_imputed_phase1_20240904.csv"
