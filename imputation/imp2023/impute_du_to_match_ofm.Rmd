...
* parcels.csv (from 2018; in ref2018 directory)
* one of:
...
```{r, echo=TRUE}
bld.file.name <- "buildings_imputed_phase1_20240205.csv"
...
if(adjust.to.synthpop){
  ...
  cb <- block.lu
  control.dt <- ofm[, .(county_id, census_2020_block_group_id, HH = round(sum(HH))), 
