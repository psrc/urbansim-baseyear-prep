...
set.seed(123)
bld <- fread("../../../imputation/data2023/buildings_imputed_phase3_lodes_20240305.csv") # latest buildings dataset
pcl18 <- fread("../../../imputation/data2023/ref2018/parcels.csv") # 2018 parcels
